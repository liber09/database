CREATE DATABASE [webshop]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'webshop', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\webshop.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'webshop_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\webshop_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
GO
...
GO
ALTER DATABASE [webshop] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
USE [webshop]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [webshop] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
